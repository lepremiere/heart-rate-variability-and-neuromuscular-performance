function transformedData = DataTransformation (groupData, baseline_name)
...
ABS_mean = array2table(ABS_mean{:, 2:end},...
                   ...
                   'RowNames'     ,ABS_mean{:,1});
ABS_mean = ABS_mean(groupData{1:unique_identifier, 3},:);                                             % Sorts table to match input
...
ABS_sd = array2table(ABS_sd{:, 2:end},...
                                ...
                                'RowNames'     ,ABS_sd{:,1});
ABS_sd = ABS_sd(groupData{1:unique_identifier, 3},:);
...
ES_mean = array2table(ES_mean{:,2:end},...
                      'VariableNames',['GroupCount',groupData.Properties.VariableNames(4:end)],...
                      'RowNames',ES_mean{:,1});
ES_mean = ES_mean(ES_individual{1:unique_identifier, 3},:);
...
ES_sd = array2table(ES_sd{:,2:end},...
                    'VariableNames',['GroupCount',groupData.Properties.VariableNames(4:end)],...
                    'RowNames',ES_sd{:,1});
ES_sd = ES_sd(groupData{1:unique_identifier, 3},:);
...
percentage_mean = percentage_mean(percentage_individual{1:unique_identifier, 3},:);
...
percentage_sd = percentage_sd(groupData{1:unique_identifier, 3},:);
...
delta_ABS_mean                                   = delta_ABS_mean(delta_ABS_individual{1:unique_identifier,3},:);
...
delta_ABS_sd                                     = delta_ABS_sd(groupData{1:unique_identifier,3},:);
...
delta_PERC_mean                                   = delta_PERC_mean(delta_PERC_individual{1:unique_identifier,3},:);
...
delta_PERC_sd                                     = delta_PERC_sd(groupData{1:unique_identifier,3},:);
...
delta_ES_mean                                   = delta_ES_mean(delta_ES_individual{1:unique_identifier,3},:);
...
delta_ES_sd                                     = delta_ES_sd(groupData{1:unique_identifier,3},:);
...
transformedData = array2table(Results,'RowNames',{'Absolute_individual',...
                                                  'Percentage_individual',...
                                                  'ES_individual',...
                                                  'delta_ABS_individual',...
                                                  'delta_PERC_individual',...
